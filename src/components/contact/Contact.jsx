...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_qjl1gej', 'template_k53ucsi', form.current, {
        publicKey: 'eTrQVNdp-dSTE07aE',
      })
      e.target.reset()
  };
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">vatssneha987@gmail.com</span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">+91-817-887-1045</span>
              <div>
              <a href="" className="contact_button">Write me{' '}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
              </a>
